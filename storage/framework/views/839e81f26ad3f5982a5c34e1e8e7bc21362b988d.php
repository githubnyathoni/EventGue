...
<div class="container">
    ...
    <div class="card mt-5 mb-5 shadow bg-white rounded">
        <div class="card-header">
            <p class="text-center mb-0">Sudah Punya Akun? <a href="<?php echo e(route('login')); ?>">Login</a></p>
        </div>
        <div class="card-body">
            <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lyc\resources\views/daftar.blade.php ENDPATH**/ ?>